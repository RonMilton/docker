...
<xsl:stylesheet e:version="3.0" exclude-result-prefixes="ditaarch opentopic e" version="2.0" xmlns:ditaarch="http://dita.oasis-open.org/architecture/2005/" xmlns:e="com.ronmilton.pdf" xmlns:opentopic="http://www.idiominc.com/opentopic" xmlns:opentopic-func="http://www.idiominc.com/opentopic/exsl/function" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <!--base imports-->
  ...
  <xsl:import href="plugin:com.ronmilton.pdf:cfg/fo/attrs/basic-settings.xsl" />
  ...
  <xsl:import href="plugin:com.ronmilton.pdf:cfg/fo/attrs/front-matter-attr.xsl" />
  <xsl:import href="plugin:org.dita.pdf2:xsl/fo/front-matter.xsl" />
  <xsl:import href="plugin:com.ronmilton.pdf:xsl/fo/front-matter.xsl" />
  ...
  <xsl:import href="plugin:com.ronmilton.pdf:xsl/fo/pr-domain.xsl" />
  ...
  <xsl:import href="plugin:com.ronmilton.pdf:xsl/fo/hi-domain.xsl" />
  ...
  <xsl:import href="plugin:com.ronmilton.pdf:cfg/fo/attrs/static-content-attr.xsl" />
  <xsl:import href="plugin:org.dita.pdf2:xsl/fo/static-content.xsl" />
  <xsl:import href="plugin:com.ronmilton.pdf:xsl/fo/static-content.xsl" />
  ...
  <xsl:import href="plugin:com.ronmilton.pdf:cfg/fo/attrs/topic-attr.xsl"/>
