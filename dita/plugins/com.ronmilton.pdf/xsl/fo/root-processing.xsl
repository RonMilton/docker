...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="ds.productVersion" select="(/*/opentopic:map//*[contains(@class, ' topic/vrm ')]/@version)[1]"/>
    <xsl:variable name="ds.pubDate" select="(/*/opentopic:map//*[contains(@class, ' topic/revised ')]/@golive)[1]"/>
    <xsl:variable name="ds.copyYear" select="(/*/opentopic:map//*[contains(@class, ' topic/copyryear ')]/@year)[1]"/>
    <xsl:variable name="ds.company" select="(/*/opentopic:map//*[contains(@class, ' topic/copyrholder ')])[1]"/>
    
    <xsl:variable name="ds.address">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='address']/@value)[1]"/>
    </xsl:variable>
  
    <xsl:variable name="ds.citystatezip">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='city']/@value)[1]"/>
      <xsl:text>, </xsl:text>
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='state']/@value)[1]"/>
      <xsl:text>&#160;&#160;</xsl:text>
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='zip']/@value)[1]"/>
    </xsl:variable>
  
    <xsl:variable name="ds.website">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='website']/@value)[1]"/>
    </xsl:variable>
  
    <xsl:variable name="ds.docs-url">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='docs']/@value)[1]"/>
    </xsl:variable>
  
    <xsl:variable name="ds.support">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='support']/@value)[1]"/>
    </xsl:variable>
  
    <xsl:variable name="ds.support-email">
      <xsl:value-of select="concat('mailto:', (/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='support']/@value)[1])"/>
    </xsl:variable>
  
    <xsl:variable name="ds.phone">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='phone']/@value)[1]"/>
    </xsl:variable>
  
    <xsl:variable name="ds.tollfree">
      <xsl:value-of select="(/*/opentopic:map//*[contains(@class, ' topic/data ')][@name='tollfree']/@value)[1]"/>
    </xsl:variable>
